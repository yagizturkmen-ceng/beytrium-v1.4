  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <HiMoon />, label: "Görünüm ve Tema", desc: "Karanlık mod ve renkler", color: "bg-yellow-100 dark:bg-yellow-900/30" },
      ]
    },
    {
      title: "Destek & Diğer",
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <div className="flex items-center gap-4">
            <h1 className="text-4xl font-black uppercase tracking-tight text-black">Ayarlar</h1>
            <Link to="/admin" className="ml-2 bg-black text-white px-3 py-1 rounded-lg text-sm font-black border-2 border-black hover:bg-[#fbca1f] hover:text-black transition-colors shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center gap-1">
              <HiShieldCheck />
              ADMIN
            </Link>
          </div>
          <p className="text-gray-600 dark:text-gray-400 font-bold">Yönetim Paneli</p>
        </div>
      </div>
